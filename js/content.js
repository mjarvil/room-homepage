class Content {
  contents = [
    {
      ...
      title: 'Discover innovative ways to decorate We provide',
      description: `We provide unmatched quality, comfort, and style for property owners across the
    ...
    },
    {
      ...
      description: `With stores all over the world, it's easy for you to
    ...
    },
    {
      ...
      description: `Our modern furniture store provide a high level of quality. Our company has invested in advanced technology to
  ...
  getContent() {
    const content = contents[this.item];
    return {
